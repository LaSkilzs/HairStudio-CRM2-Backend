FactoryBot.define do
  factory :hair_card do
    ...
    which_method {"MyString"}	
    last_time_colored {"MyString"}	
    used_hair_extensions_before {false}	
    which_type_did_you_use {"MyString"}	
    have_a_perm_or_relaxer {false}	
    last_time_you_had_a_relaxer {"MyString"}	
    wash_frequency {"MyString"}	
    hair_type {"thick"}	
    hair_is {"wavy"}	
    length {"above_shoulder"}	
    user 	
    stylist 	
    hair_personality 
  end
